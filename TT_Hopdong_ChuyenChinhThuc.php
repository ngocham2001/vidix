<?php
include_once 'PHP/TT_Hopdong_ChuyenChinhThuc_PHP.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<!-- CONTENT -->
<div class="container">
    <h2>HỢP ĐỒNG CHỜ CHUYỂN CHÍNH THỨC</h2>
   <form action="" method="POST" id="search-form">
		...
		<select name="filter_status" id="filter_status" class="input-sm" style="width:220px;" onchange="document.getElementById('search-form').submit();">
			<option value="" > -- Tất cả hợp đồng chờ -- </option>
			<option value="du_dk" <?= (isset($_POST['filter_status']) && $_POST['filter_status']==='du_dk') ? 'selected' : ''; ?>> ✅ Đủ 21 ngày chuyển chính thức </option>
			<option value="chua_du" <?= (isset($_POST['filter_status']) && $_POST['filter_status']==='chua_du') ? 'selected' : ''; ?>>⏳ Chưa đủ 21 ngày </option>
		</select>
        <span class="pull-right">
            <input type="text" name="textcond"
                   value="<?php //echo isset($_POST['textcond']) ? htmlspecialchars($_POST['textcond']) : ''; ?>"
                   placeholder="Tìm số HĐ chờ, mã KH, mã NV, HSs, KB.."
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label for="ngay_huy_hd">
						Ngày hủy hợp đồng <span class="text-danger">*</span>
					</label>
					<input type="date"
						   class="form-control"
						   name="ngay_huy_hd"
            ...
            <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" name="delete-submit">
                        <span class="glyphicon glyphicon-trash"></span> Hủy hợp đồng
                    </button>
