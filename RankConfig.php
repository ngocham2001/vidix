<?php
include_once 'PHP/RankConfig_PHP.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<!-- CONTENT -->
<div class="container">
    <h2>CẤU HÌNH CẤP BẬC NHÂN VIÊN</h2>
    <form action="" method="POST">
        <a href="#" class="btn btn-primary" onclick="showNewForm();">
            <span class="glyphicon glyphicon-plus"></span> Thêm cấp bậc mới
        </a>
...
<script src="js/vidix/RankConfig.js" type="text/javascript"></script>
